...
import {
  ...
  Plus, Search, Settings, ChevronLeft, ChevronRight, Menu
} from "lucide-react";
...
export default function GlobalNav() {
          ...
          >
            ...
            <div className="border-t p-2">
              <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-accent-soft w-full text-sm"
              >
                <Settings size={18} />
                설정
              </button>
  ...
  return (
      ...
      >
        {/* Header */}
        <div className="h-14 px-3 flex items-center border-b gap-3">
          <IconButton
              icon={<span className="text-white font-bold">F</span>}
              className="w-10 h-10 bg-accent text-white"
          />
        ...
        <div className="border-t p-2 flex flex-col gap-2">
          {!isCollapsed && (
              <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-accent-soft text-sm"
              >
                <Settings size={18} />
                설정
              </button>
